...
-   فرمت ساده و انعطاف پذیر `رویداد` انتشار هر نوع محتوایی را ممکن می کند: یادداشت های شبکه های اجتماعی، محتوای طولانی، رسانه غنی، تجارت الکترونیکی و غیره.
-   قابلیت بررسی و تایید اینکه یادداشت ها از کاربری خاص صادر شده اند. این به مقابله با اسپم و بات ها کمک می کند.
-   کاربران می توانند به رله های زیادی وصل شوند و رله های خود را راه بیندازند. این سانسور ایده ها و افراد را سخت می کند.
-   در تجمیع با لایتنینگ، ناستر مدل کسب و کار جدیدی [ارزش برای ارزش](https://archive.is/https://value4value.info) را ممکن می کند که قابلیت این را دارد که منصفانه تر باشد.
-   ناستر شبکه ای برای ایجنت ها است. نه کپچا، نه تایید شماره تلفن، نه کارت اعتباری و نه هیچ محدودیتی. ناستر برای ارتباط با OpenClaw یا هر ایجنت دیگری عالی است. و چون بیتکوین در سطح پروتکل درون آن ساخته شده است، حتی می توانید در کمتر از یک دقیقه به ایجنت خود یک کیف پول بدهید. اگر می خواهید شروع به ساختن کنید، برای مستندات ناستر یک [سرور MCP](https://nostrbook.dev/mcp?utm_source=nostr.how&ref=nostr.how) هم وجود دارد.

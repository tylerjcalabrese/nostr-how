...
-   与闪电网络集成使得 Nostr 可以实现新的商业模式——[价值交换](https://archive.is/https://value4value.info)，这个模式有可能更加公平。
-   Nostr 是面向智能体的网络。没有验证码，没有手机号验证，没有信用卡，没有限制。Nostr 非常适合与你的 OpenClaw 或其他智能体通信。而且由于 Bitcoin 在协议层就是内建的，你甚至可以在一分钟内给你的智能体配一个钱包。如果你想开始构建，可以使用一个面向 Nostr 文档的 [MCP 服务器](https://nostrbook.dev/mcp?utm_source=nostr.how&ref=nostr.how)。

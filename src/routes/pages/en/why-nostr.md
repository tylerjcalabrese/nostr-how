...
-   Integrated with lightning, Nostr enables new [value-for-value](https://archive.is/https://value4value.info) business models that have the potential to be more fair.

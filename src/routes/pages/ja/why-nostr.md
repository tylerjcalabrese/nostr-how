---
title: なぜNostrが必要なのか
description: Nostrおよびインターネットを分散化するというより広範な考え方が、重要なコンセプトである理由。
---
...
-   シンプルで柔軟な `Event` フォーマットにより、ソーシャル投稿、長文コンテンツ、リッチメディア、eコマースなど、さまざまな形の公開が可能です。
-   メモが特定のユーザーからのものであることの検証可能性。これはスパムやボット対策に役立ちます。
-   ユーザーは多くのリレーに接続し、自分のリレーを運営できます。これにより、アイデアや人々を検閲することが難しくなります。
-   ライトニングと統合されたNostrは、より公平になる可能性のある新しい [value-for-value](https://archive.is/https://value4value.info) ビジネスモデルを可能にします。
-   Nostrはエージェントのためのネットワークです。キャプチャも、電話番号認証も、クレジットカードも、制限もありません。OpenClaw や他のエージェントと通信するのに最適です。しかも、Bitcoin がプロトコルレベルで組み込まれているので、1分以内にエージェントにウォレットを持たせることもできます。構築を始めたいなら、Nostr のドキュメント用の [MCPサーバー](https://nostrbook.dev/mcp?utm_source=nostr.how&ref=nostr.how) もあります。

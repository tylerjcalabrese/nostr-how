...
-   Інтегрований з Lightning, Nostr дозволяє нові бізнес-моделі [value-for-value](https://archive.is/https://value4value.info), які можуть бути більш справедливими.
-   Nostr - це мережа для агентів. Жодних капч, жодної верифікації за номером телефону, жодних кредитних карток, жодних лімітів. Nostr ідеально підходить для спілкування з вашим OpenClaw або іншим агентом. А оскільки Bitcoin вбудований на рівні протоколу, ви навіть можете дати своєму агенту гаманець менш ніж за хвилину. Якщо ви хочете почати створювати щось своє, для документації Nostr є [сервер MCP](https://nostrbook.dev/mcp?utm_source=nostr.how&ref=nostr.how).
